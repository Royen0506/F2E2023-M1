...
bannerBtn[0].addEventListener("click", function (e) {
  let str = `<div class="container" data-aos="fade-up">
            <div class="text-center">
                <img data-aos="fade-up" data-aos-delay="150" class="img-fluid d-none d-lg-inline-block" src="images/title.png" alt="">
            </div>
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="text-dark px-5 pe-lg-0 align-self-center">
                    <div class="row bg-info rounded-5 p-4">
                        ...
                        <p id="banner-p" class="body-s mt-3 d-flex justify-content-lg-center px-0">
                ...
                <img class="img-fluid mt-4 mt-lg-0 px-0" src="./images/cat2.png" alt="">
                <div class="text-center">
                    <img class="img-fluid mt-4 d-inline-block d-lg-none text-center" src="images/title-mobile.png"
                        alt="">
                </div>
            </div>
        </div>
...
bannerBtn[1].addEventListener("click", function (e) {
  let str = `<div class="container" data-aos="fade-up">
            <div class="text-center">
                <img class="img-fluid d-none d-lg-inline-block" src="images/title.png" alt="">
            </div>
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="text-dark px-5 pe-lg-0 align-self-center">
                    <div class="row bg-info rounded-5 p-4">
